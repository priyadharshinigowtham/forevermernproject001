    ...
    <div className="border-t-2 pt-10 transition-opacity ease-in duration-500 opacity-100">
      ...
      <div className='mt-20'>
        ...
        <div className='flex flex-col gap-4 border px-6 text-sm text-gray-500'>
         <p>A timeless silhouette that blends comfort and elegance, perfect for any occasion and easy to style.</p>
        <p>Soft fabric, subtle details, and effortless charm — designed to make you feel confident all day.</p>
        </div>
      </div>

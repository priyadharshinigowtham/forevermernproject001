        ...
        <div className='border-t pt-14'>
            ...
            <div>
                {cartData.map((item, index) => {
                    ...
                    if (!productData) return null; // Safety check for productData
                    ...
                    return (
                        <div key={index} className='py-4 border-b text-gray-700 grid grid-cols-[4fr_0.5fr_0.5fr] sm:grid-cols-[4fr_2fr_0.5fr] items-center gap-4'>
                            ...
                            <input onChange={(e) => e.target.value === '' || e.target.value === '0' ? null : updateQuantity(item._id, item.size, Number(e.target.value))} className='border w-10 sm:w-14 px-1 py-1' type="number" min={1} defaultValue={item.quantity} />
